...
class PersonByProfessor constructor(_firstName: String, _lastName: String) { // or class Person constructor    (_firstName: String, _lastName: String)
...
// val denis = PersonT("Denis", "Panjuta")

// Alternatively:
class PersonT (_firstName: String, _lastName: String) {
    // Member Variables (Properties) of the class
...
class PersonB(var firstName: String = "John", var lastName: String= "Doe") {
    // Initializer Block
    init {
        println("Initialized a new Person object with firstName = $firstName and lastName = $lastName")
    }
...
class PersonC(var firstName: String, var lastName: String) {
    var age: Int? = null
...
class PersonD(var firstName: String, var lastName: String) {
    var age: Int? = null
...
// three parameters
class CarT(_brand: String, _model: String, _maxSpeed: Int) {
...
class CarA(_brand: String, _model: String, _maxSpeed: Int) {
